---
**Keywords**: spellcheck, spell check, dictionary, custom dictionary, per-book dictionary, misspelled, highlights, three-tier highlighting, green highlight, red highlight, spell-unknown, spell-dictionary, view mode, edit mode, inline editing, TipTap, contentEditable, browser spell-check, red squiggles, highlights disappear, nspell, Hunspell, dictionary-en, OCR artifacts, jammed words, foreign words, Greek, German, philosophy, server-side, cheerio, text nodes, word tokenization, highlight spans, spellcheckHtml, block.html, dangerouslySetInnerHTML, TextBlock, TextBlockRichEditor, TextBlockToolbar, ReaderView, loadSection, spellcheck-section, spellcheck-block, workingFiles, dictionary.json, Modal, TopBar, dictionary modal, Add to Dictionary, PRD 1.6, ticket 107
---
